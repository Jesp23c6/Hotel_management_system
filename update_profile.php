    ...
    <div class="container-fluid" style="color:#000;">
        ...
        <div class="container">
            <h1 style="background-color:#ed2553; border-radius:50px;display:inline-block;"><b>
                    <font color="#080808">Update Account?</font>
                </b></h1>
            <div class="row">
                ...
                <div class="col-sm-6 ">
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="password" name="Passw" value="<?php echo $result['password']; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="mobi" value="<?php echo $result['mobile']; ?>"
