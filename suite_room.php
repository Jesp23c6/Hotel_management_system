        ...
        <div class="continer">
            <div class="row">
                ...
                <div class="col-sm-7">
                    ...
                    <p class="text-justify">Enjoy the view of Anand from attach sitting area, An upgraded version of the
                        Deluxe room, these rooms offer an elegant design with larger room space..</p>
                    <div class="row">
                        <h2>Amenities</h2>
