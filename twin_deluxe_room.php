        ...
        <div class="continer">
            <div class="row">
                ...
                <div class="col-sm-7">
                    ...
                    <p class="text-justify">The Contemporary yet simple designed twin bedded rooms are well equipped
                        with modern amenities. Fresh Decor and refined ambiance is the winning combination to make these
                        rooms an ideal choice for discerning business traveler.</p>
                    <div class="row">
                        <h2>Amenities</h2>
                ...
                <div class="col-sm-3">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body-right text-center">
                            <a href="Delux Room.php">Delux Room</a>
                            <hr>
                            <a href="Standard Room.php">Standard Room</a>
                            <hr>
                            <a href="Luxurious Suite.php">Luxurious Suite</a>
                            <hr>
                            <a href="Twin Delux Room.php">Twin Delux Room</a>
                            <hr>
                            <a href="Suit Room.php">Suit Room</a>
                            <hr>
                        </div>
                    </div>
                </div>
